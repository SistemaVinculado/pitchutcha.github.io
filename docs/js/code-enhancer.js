document.addEventListener("DOMContentLoaded", () => {
    ...
    document.querySelectorAll("figure.highlight, div.highlighter-rouge").forEach(codeBlock => {
        ...
        editButton.addEventListener("click", () => {
            ...
            // --- ATUALIZAÇÃO AQUI ---
            // Detecta o idioma do bloco de código a partir da classe (ex: "language-python")
            let lang = 'plaintext'; // Idioma padrão
            ...
            // Adiciona o idioma como um segundo parâmetro na URL
